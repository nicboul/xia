...
-- @link_state  INT     Connection status (xia/session_msg.h)
...
CREATE TABLE `tokens` (
    ...
    `link_state`    TINYINT UNSIGNED NOT NULL DEFAULT 0,
...
--
--  This table contains informations about ressources token
--
--
-- @token       INT     Link to Token identifier
...
-- res_discovery: description
--
--  This table contains informations about ressources discovered
--  by the bridges.
--
--
...
-- res_discovery: privileges
--
--  READ ONLY:
--  READ/WRITE: xiad, web
--
GRANT SELECT, INSERT, UPDATE, DELETE
        ON `res_discovery` TO `CONFIG_USER_XIA`@`CONFIG_HOST_XIA`;
GRANT SELECT, INSERT, UPDATE, DELETE
        ON `res_discovery` TO `CONFIG_USER_WEB`@`CONFIG_HOST_WEB`;


-- res_discovery_extra: description
--
--  This table contains EXTRA informations about ressources discovered
--  by the bridges.
--
--
-- @discovery   INT     Link to Discovery identifier
-- @os_name     STR     Name of the Operating System
-- @desc        STR     A description, a note, etc.
--
CREATE TABLE `res_discovery_extra` (
    `discovery` INTEGER UNSIGNED NOT NULL,
    `os_name`   VARCHAR(128),
    `desc`      TEXT,
...
-- res_discovery_extra: privileges
--
--  READ ONLY:
--  READ/WRITE: web
--
GRANT SELECT, INSERT, UPDATE, DELETE
        ON `res_discovery_extra` TO `CONFIG_USER_WEB`@`CONFIG_HOST_WEB`;
