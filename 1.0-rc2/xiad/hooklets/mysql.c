...
{
	journal_ftrace("init_input_buffer");
...
void init_output_buffer(struct stmt_singleton *s,
			  MYSQL_BIND *buf, size_t buf_size)
{
	journal_ftrace("init_output_buffer");
...
{
	journal_ftrace("get_token_type_init_once");
...
{
	journal_ftrace("get_token_status_init_once");
...
{
	journal_ftrace("get_token_status");
...
{
	journal_ftrace("get_res_membership_init_once");
...
{
	journal_ftrace("get_res_membership");
...
{
	journal_ftrace("get_usr_membership_init_once");
...
{
	journal_ftrace("get_usr_membership");
...
{
	journal_ftrace("get_bridge_owner_context_init_once");
...
{
	journal_ftrace("get_bridge_owner_context");
...
{
	journal_ftrace("set_token_addr_mapping_init_once");
...
{
	journal_ftrace("set_token_addr_mapping");
...
{
	journal_ftrace("unset_token_addr_mapping_init_once");
...
{
	journal_ftrace("unset_token_addr_mapping");
...
{
	journal_ftrace("set_res_addr_mapping_init_once");
...
{
	journal_ftrace("set_res_addr_mapping");
...
{
	journal_ftrace("set_res_hostname_mapping_init_once");
...
{
	journal_ftrace("set_res_hostname_mapping");
